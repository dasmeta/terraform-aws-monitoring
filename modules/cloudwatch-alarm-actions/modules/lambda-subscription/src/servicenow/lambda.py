...
def handler(event, context):
    ...
    print("> ServiceNow Endpoint: ", environ["SERVICENOW_DOMAIN"], environ["SERVICENOW_PATH"])

    connection = http.client.HTTPSConnection(environ["SERVICENOW_DOMAIN"], 443)
    connection.set_debuglevel(DEBUG)

    credentials_base64 = base64.b64encode(bytes(environ["SERVICENOW_USER"] + ':' + environ["SERVICENOW_PASS"], "utf-8")).decode("utf-8")
