...
| <a name="input_runtime"></a> [runtime](#input\_runtime) | Lambda runtime. Existing predefined handlers retain Python 3.9 unless explicitly overridden. | `string` | `"python3.9"` | no |
