...
|------|-------------|------|---------|:--------:|
| <a name="input_alerts"></a> [alerts](#input\_alerts) | Allows to create standard and log based metric alarms | <pre>list(object({<br/>    name                             = string<br/>    source                           = string<br/>    filters                          = map(any)<br/>    description                      = optional(string, null)<br/>    evaluation_periods               = optional(number, 1)<br/>    statistic                        = optional(string, "sum")<br/>    equation                         = optional(string, "gte")<br/>    threshold                        = optional(number, 1)<br/>    period                           = optional(number, 300)<br/>    treat_missing_data               = optional(string, null)<br/>    log_based_metric                 = optional(bool, false)<br/>    anomaly_detection                = optional(bool, false)<br/>    fill_insufficient_data           = optional(bool, false)<br/>    enable_insufficient_data_actions = optional(bool, null)<br/>    account_id                       = optional(string, null)<br/>  }))</pre> | `[]` | no |
| <a name="input_client_name"></a> [client\_name](#input\_client\_name) | Client name to include in generated CloudWatch alarm descriptions. | `string` | `null` | no |
